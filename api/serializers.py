...
from .models import Scheduler, CustomUser, HolidayRequest, HolidayType, Notification, HolidayPlan, DataChangeRequest, HolidayRequestPlan
...
class HolidayRequestPlanSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = HolidayRequestPlan
        fields = ['id', 'user', 'start_date', 'end_date', 'difference_in_days', 'selected_holiday_type',
                  'message', 'created_at', 'approved', 'color_hex']
    ...
    def create(self, validated_data):
        ...
        holiday_plan_request = HolidayRequestPlan.objects.create(user=user_instance, **validated_data)
        return holiday_plan_request
