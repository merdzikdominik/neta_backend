...
#     # city_permanent_residence = models.CharField(max_length=50, blank=True, null=True)
#     # postal_code_permanent_residence = models.CharField(max_length=20, default='')
#     # post_permanent_residence = models.CharField(max_length=100, default='')
#     # municipal_commune_permanent_residence = models.CharField(max_length=100, default='')
#     # voivodeship_permanent_residence = models.CharField(max_length=100, default='')
#     # country_permanent_residence = models.CharField(max_length=100, default='')
#     # street_permanent_residence = models.CharField(max_length=100, default='')
#     # house_number_permanent_residence = models.CharField(max_length=10, default='')
#     # flat_number_permanent_residence = models.CharField(max_length=10, default='')
#     # mobile_number_permanent_residence = models.CharField(max_length=20, default='')
#     # city_second_residence = models.CharField(max_length=100, default='')
#     # postal_code_second_residence = models.CharField(max_length=20, default='')
#     # post_second_residence = models.CharField(max_length=100, default='')
#     # municipal_commune_second_residence = models.CharField(max_length=100, default='')
#     # voivodeship_second_residence = models.CharField(max_length=100, default='')
#     # country_second_residence = models.CharField(max_length=100, default='')
#     # street_second_residence = models.CharField(max_length=100, default='')
#     # house_number_second_residence = models.CharField(max_length=10, default='')
#     # flat_number_second_residence = models.CharField(max_length=10, default='')
#     # mobile_number_second_residence = models.CharField(max_length=20, default='')
#     # city_correspondence_residence = models.CharField(max_length=100, default='')
#     # postal_code_correspondence_residence = models.CharField(max_length=20, default='')
#     # post_correspondence_residence = models.CharField(max_length=100, default='')
#     # municipal_commune_correspondence_residence = models.CharField(max_length=100, default='')
#     # voivodeship_correspondence_residence = models.CharField(max_length=100, default='')
#     # country_correspondence_residence = models.CharField(max_length=100, default='')
#     # street_correspondence_residence = models.CharField(max_length=100, default='')
#     # house_number_correspondence_residence = models.CharField(max_length=10, default='')
#     # flat_number_correspondence_residence = models.CharField(max_length=10, default='')
#     # mobile_number_correspondence_residence = models.CharField(max_length=20, default='')
#     # correspondence_address = models.CharField(max_length=100, default='')
#     # tax_office = models.CharField(max_length=100, default='')
#     # annual_settlement_address = models.CharField(max_length=100, default='')
    nfz_branch = models.CharField(max_length=100, default='')
    id_data = models.CharField(max_length=100, default='')
    id_given_by = models.CharField(max_length=100, default='')
