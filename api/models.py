...
class DataChangeRequest(models.Model):
    ...
    # postal_code_permanent_residence = models.TextField(max_length=20, blank=True, default='')
    # post_permanent_residence = models.TextField(max_length=100, blank=True, default='')
    # municipal_commune_permanent_residence = models.TextField(max_length=100, blank=True, default='')
    # voivodeship_permanent_residence = models.TextField(max_length=100, blank=True, default='')
    # country_permanent_residence = models.TextField(max_length=100, blank=True, default='')
    # street_permanent_residence = models.TextField(max_length=100, blank=True, default='')
    # house_number_permanent_residence = models.TextField(max_length=10, blank=True, default='')
    # flat_number_permanent_residence = models.TextField(max_length=10, blank=True, default='')
    # mobile_number_permanent_residence = models.TextField(max_length=20, blank=True, default='')
    # city_second_residence = models.TextField(max_length=100, blank=True, default='')
    # postal_code_second_residence = models.TextField(max_length=20, blank=True, default='')
    # post_second_residence = models.TextField(max_length=100, default='')
    # municipal_commune_second_residence = models.TextField(max_length=100, blank=True, default='')
    # voivodeship_second_residence = models.TextField(max_length=100, blank=True, default='')
    # country_second_residence = models.TextField(max_length=100, blank=True, default='')
    # street_second_residence = models.TextField(max_length=100, blank=True, default='')
    # house_number_second_residence = models.TextField(max_length=10, blank=True, default='')
    # flat_number_second_residence = models.TextField(max_length=10, blank=True, default='')
    # mobile_number_second_residence = models.TextField(max_length=20, blank=True, default='')
    # city_correspondence_residence = models.TextField(max_length=100, blank=True, default='')
    # postal_code_correspondence_residence = models.TextField(max_length=20, blank=True, default='')
    # post_correspondence_residence = models.TextField(max_length=100, blank=True, default='')
    # municipal_commune_correspondence_residence = models.TextField(max_length=100, blank=True, default='')
    # voivodeship_correspondence_residence = models.TextField(max_length=100, blank=True, default='')
    # country_correspondence_residence = models.TextField(max_length=100, blank=True, default='')
    # street_correspondence_residence = models.TextField(max_length=100, blank=True, default='')
    # house_number_correspondence_residence = models.TextField(max_length=10, blank=True, default='')
    # flat_number_correspondence_residence = models.TextField(max_length=10, blank=True, default='')
    # mobile_number_correspondence_residence = models.TextField(max_length=20, blank=True, default='')
    # correspondence_address = models.TextField(max_length=100, blank=True, default='')
    # tax_office = models.TextField(max_length=100, blank=True, default='')
    # annual_settlement_address = models.TextField(max_length=100, default='')
